    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          leading: Image(
            image: AssetImage('image/logo.png'), // Ganti dengan path gambar logo Anda
            width: 50, // Atur lebar gambar logo sesuai kebutuhan
            height: 50, // Atur tinggi gambar logo sesuai kebutuhan
          ),
      ),
        backgroundColor: Colors.grey.shade900,
        body: const SafeArea(
